...
Pairwise = {};
nPairWise = 0;
for Step2 = 1:1 %%%% comparison between Samples
...
%                 Pairwise{nPairWise,3} = countMatch;
                Pairwise{nPairWise,3} = Similarity_Total;                
                Pairwise{nPairWise,4} = Compare_Total_Effective;
                Pairwise{nPairWise,5} = Compare_Total;
                Pairwise{nPairWise,6} = (Pairwise{nPairWise,5}/(Pairwise{nPairWise,3}))^2/100; %%%% reversed average 1/Similarity
                Pairwise{nPairWise,7} = log(Pairwise{nPairWise,6}); %% MecDistance
            end            
        end
    end
end